...
const SessionsTab: React.FC<SessionsTabProps> = ({
  ...
  return (
    <div className="space-y-8 animate-fadeIn" id="tab-sessions-panel">
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-850 rounded-3xl p-6 shadow-xs space-y-4">
        <div className="flex items-center pb-2.5 border-b border-zinc-150 dark:border-zinc-800">
        <div className="space-y-1">
        ...
        <span className="text-xs bg-zinc-100 dark:bg-zinc-800 text-zinc-400 px-3 py-1.5 rounded-xl font-mono ml-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-3 p-3 bg-zinc-50 dark:bg-zinc-950 rounded-2xl border border-zinc-100 dark:border-zinc-900">
          ...
          <div className="relative w-full sm:w-48 shrink-0">
            ...
            <input
              ...
              placeholder={lang === 'vi' ? "Tìm theo ngày" : "Search by date"}
              className="w-full pl-9 pr-14 py-2 text-xs bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200 rounded-xl focus:outline-none focus:ring-1 focus:ring-rose-500 font-sans"
            />
            {sessionDateFilter && (
              <button 
