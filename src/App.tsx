                  ...
                  return (
                    <div className="mb-4 bg-white/70 dark:bg-zinc-900/40 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/60 rounded-2xl p-4 shadow-md dark:shadow-none relative overflow-hidden" id="protpick-notification-center">
                      <div className="absolute right-3 top-3 opacity-[0.06] dark:opacity-10 pointer-events-none">
                        <Bell className="w-16 h-16 text-rose-500 dark:text-rose-400/60" />
                      </div>
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 text-[10px] font-black text-rose-600 dark:text-rose-400 uppercase tracking-widest font-mono">
                        ...
                        {latestNoti ? (
                          <div id={`noti-${latestNoti.id}`} className={`space-y-1 transition-all duration-300 ${
                            ...
                            <h3 className="text-sm font-black text-zinc-900 dark:text-zinc-50 tracking-tight leading-snug">
                            ...
                            <div className="flex flex-wrap items-center gap-2 pt-1.5 text-[9px] text-zinc-500 dark:text-zinc-400 font-mono">
                              ...
                              {!latestNoti.isPublic && <span className="bg-zinc-150 dark:bg-zinc-800 text-zinc-650 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-750 px-1 py-0.5 rounded font-bold">Private</span>}
                              {role === 'coach' && (
                          ...
                          <div className="flex items-center justify-between gap-2 text-[11px]">
                            ...
                            <div className="flex gap-1.5">
                              <button type="button" onClick={() => setNewNoti(null)}
                                className="px-3 py-1 bg-zinc-200 dark:bg-zinc-800 text-zinc-750 dark:text-zinc-400 rounded-xl cursor-pointer hover:bg-zinc-300 dark:hover:bg-zinc-700 transition-colors">Cancel</button>
                              <button type="submit" className="px-3 py-1 bg-rose-600 hover:bg-rose-700 text-white font-bold rounded-xl cursor-pointer shadow-sm transition-colors">{t.addNotiBtn}</button>
                            </div>
                          </div>
                        </form>
                      )}
