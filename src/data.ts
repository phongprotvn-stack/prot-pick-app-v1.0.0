...
export const initialSkills: CurriculumSkill[] = [
  ...
  { id: '9', name: 'Flick', category: 'Hard Drives', descriptionVI: 'Kỹ thuật gõ bóng cổ tay đột ngột tăng tốc lực', descriptionEN: 'Sudden wrist flick to catch opponent off guard' },
  { id: '10', name: 'Roll', category: 'Hard Drives', descriptionVI: 'Gạt bóng xoáy lên từ dưới kitchen lên', descriptionEN: 'Topspin roll from below or near kitchen height' },
  { id: '11', name: 'Reset', category: 'Defense & Reset', descriptionVI: 'Đưa trái bóng bay nhanh về nhịp dink chậm an toàn', descriptionEN: 'Neutralize fast balls back into the kitchen' },
